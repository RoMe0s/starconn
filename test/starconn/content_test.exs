defmodule Starconn.ContentTest do
  use Starconn.DataCase

  alias Starconn.Content

  describe "posts" do
    alias Starconn.Content.Post.Post

    @valid_attrs %{content: "some content", description: "some description", name: "some name"}
    @update_attrs %{content: "some updated content", description: "some updated description", name: "some updated name"}
    @invalid_attrs %{content: nil, description: nil, name: nil}
